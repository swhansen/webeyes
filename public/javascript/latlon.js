 ...
 * @param   {LatLon} point - Latitude/longitude of destination point.
 * @param   {number} [radius=6371e3] - (Mean) radius of earth (defaults to radius in metres).
 * @returns array {number} x and y cartesian distance from point in meters
 *
 * @example
 *     var p1 = new LatLon(42.622023, -71.601175);
 *     var tNorth = new LatLon( 42.623, -71.601175 );
 *     var c1 = p1.threeXZ( tNorth ); // [ 0, 108.63744333123427 ] m
 */
LatLon.prototype.threeXZ = function(point, radius) {
    if (!(point instanceof LatLon)) throw new TypeError('point is not LatLon object');
    radius = (radius === undefined) ? 6371e3 : Number(radius);

    var R = radius;

    // magnetic declonation correction 14.5 degrees

    var φ1 = this.lat.toRadians() + 0.25307;
    var λ1 = this.lon.toRadians();
    var φ2 = point.lat.toRadians() + 0.25307;
...
//    var p1 = new LatLon(42.622035, -71.609048);
//
//     var shay = new LatLon(42.624674, -71.609681);
//     var doug = new LatLon(42.622166, -71.610383 );
//     var back = new LatLon(42.619630, -71.610078);
//     var chix = new LatLon( 42.622299, -71.609188 );
//     var circle = new LatLon( 42.622234, -71.609695 );
//
//    // Test cases
//
//     var tNorth = new LatLon( 42.623, -71.609040 );
//     var tSouth = new LatLon( 42.621, -71.609040 );
//     var tEast = new LatLon( 42.622029, -71.61 );
//     var tWest = new LatLon( 42.622029, -71.608 );
//
//
//    var tList = [ tNorth, tSouth, tEast, tWest ];
//  //  var tList = [ shay, doug, chix, back ];
//
//    tList.forEach( function( el ) {
//        var dist = p1.distanceTo( el );
//    //    console.log( 'distance:', dist);
//        var b1 = p1.bearingTo( el );
//    //    console.log('bearing: ', b1 );
//        var c1 = p1.threeXZ( el );
//    //    console.log( 'coord X-Z: ', c1 );
//     } );
//
//    var target = chix;
//   var dist = p1.distanceTo( target );
//   // console.log( 'distance:', dist);
//   var b1 = p1.bearingTo( target );
//   // console.log('bearing: ', b1 );
//    var c1 = p1.threeXZ( target );
//   //console.log( 'coord X-Z: ', c1 );
//