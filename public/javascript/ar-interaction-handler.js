function arInteractionEventsHandler() {
...
$( function() {
  ...
  function emitArObject( data ) {
    ...
    socketServer.emit( 'arObjectShare', data );
  }
...
//  var dragControls = new THREE.DragControls( scene.children, vrDrivenCamera, arCanvas );
...
//  console.log( 'Got dragControles Start' );
...
// experimental case for IOT objects
// moved all functionality to smart IOT object swh:1-29-18

    if ( selectedObject.userData.isIot === true ) {
      console.log( 'IOT objects Clicked:', selectedObject );
        selectedObject.toggleIotDevice();
       }
